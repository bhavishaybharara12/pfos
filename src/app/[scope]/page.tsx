...
export default async function Home({ params }: { params: Promise<{ scope: string }> }) {
          ...
          <div>
            ...
            {health.biggestDrag && (
              <div className="text-xs text-ink-soft leading-snug">
                biggest drag:
                <br />
                <Link href={`${base}/insights`} className="text-brand font-medium">
        ...
        <Card className="flex items-center gap-4">
          ...
          <div>
            ...
            <div className="text-xs text-ink-soft leading-snug">
              ...
              <br />
              <Link href={`${base}/retirement`} className="text-brand font-medium">
                plan →
              </Link>
            </div>
          </div>
      ...
      <div className="grid lg:grid-cols-2 gap-5">
        <Card>
          ...
          <div className="space-y-3">
            {goals.map((g) => (
              <Link key={g.id} href={`${base}/goals`} className="block group">
